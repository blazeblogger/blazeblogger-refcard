...
\begin{examples}
  ...
  \command{blaze-add -{}-no-processor}{disable the use of processor}
\end{examples}
...
\begin{examples}
  ...
  \command{blaze-add -{}-page -{}-no-processor}{disable the use of processor}
\end{examples}

Use helpful placeholders:

\begin{examples}
  \command{$<$!-{}- break -{}-$>$}{place `read more' link here}
...
\begin{examples}
  ...
  \command{blaze-edit -{}-no-processor 1}{disable the use of processor}
...
\begin{examples}
  ...
  \command{blaze-edit -{}-no-processor -{}-page 1}{disable the use of processor}
...
Copyright \copyright\ 2009, 2010 Jaromír Hradílek \textsl{$<$jhradilek@gmail.com$>$}

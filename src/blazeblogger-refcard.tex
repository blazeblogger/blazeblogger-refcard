...
\heading{BlazeBlogger Quick Reference Card}{(for version 1.0.0)}
...
Copyright \copyright\ 2009 Jaromir Hradilek

\vspace{.5em}

Permission is granted to copy, distribute and/or modify this document under
the terms of the \textit{GNU Free Documentation License}, Version 1.3 or any later

...
\begin{examples}
  \command{blaze-config core.editor nano}{choose external text editor}
...
\noindent Enable coloured output:
...
\noindent Choose other markup language:

\begin{examples}
  \plaincommand{blaze-config core.processor `markdown -{}-html4tags \%in\% $>$ \%out\%'}{}
\end{examples}
